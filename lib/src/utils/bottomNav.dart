...
class CustomGNavWidget extends StatefulWidget {
...
class _CustomGNavWidgetState extends State<CustomGNavWidget> {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: SingleChildScrollView(
          // Bọc GNav bằng SingleChildScrollView
          scrollDirection: Axis.horizontal, // Cho phép cuộn theo chiều ngang
          child: GNav(
